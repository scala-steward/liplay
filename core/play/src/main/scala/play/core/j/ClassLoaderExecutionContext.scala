...
object ClassLoaderExecutionContext:
   ...
   */
  def fromThread(delegate: ExecutionContextExecutor): ExecutionContextExecutor = fromThread(
...
class ClassLoaderExecutionContext(contextClassLoader: ClassLoader, delegate: ExecutionContext)
  ...
  override def prepare(): ExecutionContext =
    ...
    if delegatePrepared eq delegate then this
    else new ClassLoaderExecutionContext(contextClassLoader, delegatePrepared)
