 ...
 *
 * This is made available implicitly to PathBindables and QueryStringBindables in the reverse router so that
 * they can query the fixed params that are passed to the action.
 *
