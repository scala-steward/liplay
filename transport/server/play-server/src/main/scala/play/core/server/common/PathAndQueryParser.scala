...
private[server] object PathAndQueryParser:
  ...
  /**
   * Parse URI String into path and query string parts. The path part is validated using [[java.net.URI]].
   *
  ...
  /**
   * Parse URI String and extract the path part only. The path part is validated using [[java.net.URI]].
   *
   * See https://tools.ietf.org/html/rfc3986
   *
   * @throws IllegalArgumentException
